namespace QnSContactManager.Logic.Entities.Persistence.App
{
	using System;
	partial class Contact : QnSContactManager.Contracts.Persistence.App.IContact
	{
		static Contact()
		{
			ClassConstructing();
		...
		public System.String Addresse
		{
			...
			{
				bool handled = false;
				OnAddresseChanging(ref handled, ref _addresse);
				if (handled == false)
				{
		...
		private System.String _addresse;
		partial void OnAddresseReading();
		partial void OnAddresseChanging(ref bool handled, ref System.String _addresse);
		partial void OnAddresseChanged();
		public QnSContactManager.Contracts.Modules.App.ContactType Type
		{
			get
			{
				OnTypeReading();
		...
		private QnSContactManager.Contracts.Modules.App.ContactType _type;
		partial void OnTypeReading();
		partial void OnTypeChanging(ref bool handled, ref QnSContactManager.Contracts.Modules.App.ContactType _type);
		partial void OnTypeChanged();
		public void CopyProperties(QnSContactManager.Contracts.Persistence.App.IContact other)
		{
			if (other == null)
			{
			...
			if (handled == false)
			{
				...
				Name = other.Name;
				Email = other.Email;
				Addresse = other.Addresse;
				Type = other.Type;
			}
			AfterCopyProperties(other);
		}
		partial void BeforeCopyProperties(QnSContactManager.Contracts.Persistence.App.IContact other, ref bool handled);
		partial void AfterCopyProperties(QnSContactManager.Contracts.Persistence.App.IContact other);
		public override bool Equals(object obj)
		{
			if (!(obj is QnSContactManager.Contracts.Persistence.App.IContact instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
		}
		protected bool Equals(QnSContactManager.Contracts.Persistence.App.IContact other)
		{
			if (other == null)
			{
				return false;
			}
			return Id == other.Id && IsEqualsWith(Timestamp, other.Timestamp) && IsEqualsWith(Name, other.Name) && IsEqualsWith(Email, other.Email) && IsEqualsWith(Addresse, other.Addresse) && Type == other.Type;
		}
		public override int GetHashCode()
		{
			return HashCode.Combine(Id, Timestamp, Name, Email, Addresse, Type);
		}
	}
}
namespace QnSContactManager.Logic.Entities.Persistence.App
{
	partial class Contact : IdentityObject
	{
	}
}
namespace QnSContactManager.Logic.Entities.Persistence.App
...
namespace QnSContactManager.Logic.Entities.Persistence.Account
{
	using System;
	partial class ActionLog : QnSContactManager.Contracts.Persistence.Account.IActionLog
	{
		static ActionLog()
		{
			ClassConstructing();
		...
		public override bool Equals(object obj)
		{
			if (!(obj is QnSContactManager.Contracts.Persistence.Account.IActionLog instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
...
namespace QnSContactManager.Logic.Entities.Persistence.Account
{
	...
	{
		public QnSContactManager.Logic.Entities.Persistence.Account.Identity Identity
		{
			get;
			set;
		}
...
{
	using System;
	partial class Identity : QnSContactManager.Contracts.Persistence.Account.IIdentity
	{
		static Identity()
		{
			ClassConstructing();
		...
		public override bool Equals(object obj)
		{
			if (!(obj is QnSContactManager.Contracts.Persistence.Account.IIdentity instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
...
namespace QnSContactManager.Logic.Entities.Persistence.Account
{
	...
	{
		public System.Collections.Generic.ICollection<QnSContactManager.Logic.Entities.Persistence.Account.ActionLog> ActionLogs
		{
			get;
			set;
		}
		public System.Collections.Generic.ICollection<QnSContactManager.Logic.Entities.Persistence.Account.IdentityXRole> IdentityXRoles
		{
			get;
			set;
		}
		public System.Collections.Generic.ICollection<QnSContactManager.Logic.Entities.Persistence.Account.LoginSession> LoginSessions
		{
			get;
			set;
		}
...
{
	using System;
	partial class IdentityXRole : QnSContactManager.Contracts.Persistence.Account.IIdentityXRole
	{
		...
		public void CopyProperties(QnSContactManager.Contracts.Persistence.Account.IIdentityXRole other)
		{
			if (other == null)
			{
				throw new System.ArgumentNullException(nameof(other));
		...
		partial void BeforeCopyProperties(QnSContactManager.Contracts.Persistence.Account.IIdentityXRole other, ref bool handled);
		partial void AfterCopyProperties(QnSContactManager.Contracts.Persistence.Account.IIdentityXRole other);
		public override bool Equals(object obj)
		{
			if (!(obj is QnSContactManager.Contracts.Persistence.Account.IIdentityXRole instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
		}
		protected bool Equals(QnSContactManager.Contracts.Persistence.Account.IIdentityXRole other)
		{
			if (other == null)
			{
				return false;
...
namespace QnSContactManager.Logic.Entities.Persistence.Account
{
	partial class IdentityXRole
	{
		...
		public QnSContactManager.Logic.Entities.Persistence.Account.Role Role
		{
			get;
			set;
		}
...
{
	using System;
	partial class LoginSession : QnSContactManager.Contracts.Persistence.Account.ILoginSession
	{
		static LoginSession()
		{
			ClassConstructing();
		...
		public void CopyProperties(QnSContactManager.Contracts.Persistence.Account.ILoginSession other)
		{
			if (other == null)
			{
				throw new System.ArgumentNullException(nameof(other));
		...
		partial void BeforeCopyProperties(QnSContactManager.Contracts.Persistence.Account.ILoginSession other, ref bool handled);
		partial void AfterCopyProperties(QnSContactManager.Contracts.Persistence.Account.ILoginSession other);
		public override bool Equals(object obj)
		{
			if (!(obj is QnSContactManager.Contracts.Persistence.Account.ILoginSession instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
		}
		protected bool Equals(QnSContactManager.Contracts.Persistence.Account.ILoginSession other)
		{
			if (other == null)
			{
				return false;
...
{
	using System;
	partial class Role : QnSContactManager.Contracts.Persistence.Account.IRole
	{
		static Role()
		{
			ClassConstructing();
		...
		public override bool Equals(object obj)
		{
			if (!(obj is QnSContactManager.Contracts.Persistence.Account.IRole instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
