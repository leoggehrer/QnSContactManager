namespace QnSContactManager.Logic.Entities.Modules.Account
{
	using System;
	partial class Login : QnSContactManager.Contracts.Modules.Account.ILogin
	{
		static Login()
		{
			ClassConstructing();
		...
		{
			if (!(obj is QnSContactManager.Contracts.Modules.Account.ILogin instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
		}
		protected bool Equals(QnSContactManager.Contracts.Modules.Account.ILogin other)
		{
			if (other == null)
			{
				return false;
...
{
	using System;
	partial class LoginUser : QnSContactManager.Contracts.Modules.Account.ILoginUser
	{
		static LoginUser()
		{
			ClassConstructing();
		...
		public override bool Equals(object obj)
		{
			if (!(obj is QnSContactManager.Contracts.Modules.Account.ILoginUser instance))
			{
				return false;
			}
			return base.Equals(instance) && Equals(instance);
